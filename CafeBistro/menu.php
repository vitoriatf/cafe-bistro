...
<body>
    <div class="menu">
        <div class="user-info dropdown">
            ...
            <div class="user-name"><?= $_SESSION['NomeUsuario']; ?>
            </div>
            <div class="dropdown-content">
                <!-- Conteúdo do dropdown -->
                <a class="dropdown-item" href="admin.php">Administrar produtos</a>
                <a class="dropdown-item" href="cadastrar-produto.php">Cadastrar produtos</a>
